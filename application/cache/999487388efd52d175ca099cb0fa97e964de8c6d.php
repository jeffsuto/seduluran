...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <?php echo $__env->make('template.admin.navbar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        ...
        <div class="content-wrapper">
          ...
          <div class="page-header page-header-default">
  					...
  					<div class="breadcrumb-line">
  						<ul class="breadcrumb">
  							<li><a href="<?php echo e(base_url('admin')); ?>"><i class="icon-home2 position-left"></i> Home</a></li>
