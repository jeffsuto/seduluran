		...
		<div class="page-content">
			...
			<div class="content-wrapper">
				...
				<div class="content">
					...
					<!-- Advanced login -->
					<form action="<?php echo e(base_url('authentication/login/admin')); ?>" method="post">
						<div class="panel panel-body login-form">
							<div class="text-center">
								<div class="icon-object border-slate-300 text-slate-300"><i class="icon-reading"></i></div>
								<h5 class="content-group">Login to your dashboard <small class="display-block">Your credentials</small></h5>
							</div>
