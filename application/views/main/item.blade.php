  ...
  <section class="page-header">
		<div class="container">
			<ul class="breadcrumb">
				...
				<li class="ctg"><a href="{{base_url('id/c/'.strtolower($cat->ctg_type_name))}}">{{strtolower($cat->ctg_type_name)}}</a></li>
				@isset($sub)
          <li class="sub"><a href="{{base_url('id/c/'.strtolower($cat->ctg_type_name).'/'.$sub)}}">{{$sub}}</a></li>
        @endisset
        @isset($item)
          <li class="active">{{ucwords($item)}}</li>
        @endisset
			</ul>
		</div>
	</section>
  <div class="container">
		<div class="product-view">
			<div class="product-essential">
              ...
              <div class="product-img-wrapper">
              	<img id="product-zoom" src="{{base_url()}}assets/images/{{$cat->img_main}}" data-zoom-image="{{base_url()}}assets/images/{{$cat->img_main}}" alt="{{$cat->item_name}}">
              </div>
              ...
              <div class="product-short-desc">
						...
						<div class="product-detail-info">
							<div class="product-price-box">
								<span class="product-price">Rp. {{$cat->item_price}}</span>
							</div>
							<p class="availability">
								<span class="font-weight-semibold">Ketersediaan:</span>
								@if ($cat->item_status == 'READY')
                  Ada
                @else
                  Kosong
                @endif
            ...
            <div class="product-actions">
                ...
                <input type="number" min="0" value="1" class="form-control item-qty">
  						...
  						<a href="{{base_url('id/cart/?code='.$code)}}" onclick="addCart('{{$code}}')" class="addtocart" title="Add to Cart">
    ...
    <div class="owl-carousel owl-theme" data-plugin-options="{'items':4, 'margin':20, 'nav':true, 'dots': false, 'loop': false}">
			<div class="product">
				<figure class="product-image-area">
					<a href="#" title="Product Name" class="product-image">
						<img src="{{base_url()}}assets/img/demos/shop/products/product1.jpg" alt="Product Name">
						<img src="{{base_url()}}assets/img/demos/shop/products/product1-2.jpg" alt="Product Name" class="product-hover-image">
					</a>
			...
			<div class="product">
				<figure class="product-image-area">
					<a href="#" title="Product Name" class="product-image">
						<img src="{{base_url()}}assets/img/demos/shop/products/product2.jpg" alt="Product Name">
						<img src="{{base_url()}}assets/img/demos/shop/products/product2-2.jpg" alt="Product Name" class="product-hover-image">
					</a>
			...
			<div class="product">
				<figure class="product-image-area">
					<a href="#" title="Product Name" class="product-image">
						<img src="{{base_url()}}assets/img/demos/shop/products/product3.jpg" alt="Product Name">
					</a>
			...
			<div class="product">
				<figure class="product-image-area">
					<a href="#" title="Product Name" class="product-image">
						<img src="{{base_url()}}assets/img/demos/shop/products/product4.jpg" alt="Product Name">
					</a>
			...
			<div class="product">
				<figure class="product-image-area">
					<a href="#" title="Product Name" class="product-image">
						<img src="{{base_url()}}assets/img/demos/shop/products/product11.jpg" alt="Product Name">
					</a>
